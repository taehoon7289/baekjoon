...
public class Class08_1 {
  public static void main(String[] args) {
    ...
    sc.close();
    double breakEvenPoint = (double)A / (C - B);
    if (breakEvenPoint < 0) {
      System.out.println(-1);
      return;
    }
    if (breakEvenPoint > Integer.MAX_VALUE) {
      System.out.println(-1);
      return;
    }
    if ((int)breakEvenPoint - breakEvenPoint == 0) {
      breakEvenPoint++;
    }
    System.out.println((int) Math.ceil(breakEvenPoint));
  }
}
